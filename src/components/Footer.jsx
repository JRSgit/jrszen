...
function Footer() {
  return (
    <footer className='w-full grid grid-cols-1 md:grid-cols-3 gap-3 items-center justify-center bg-slate-800 md:px-4 mt-20'>
      ...
      <nav className="flex gap-2 w-fit justify-center m-auto ">
